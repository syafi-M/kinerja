    ...
    <x-main-div>
        ...
        @if (Auth::user()->divisi->jabatan->code_jabatan == 'CO-CS')
            <div class="mx-10 my-5 flex flex-col gap-2">
                ...
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Labsensi">
                    <a href="{{ route('lead_absensi') }}" class="btn btn-info w-full"><i
                            class="ri-todo-line text-xl"></i>Data
                        Absensi</a>
                </div>
                ...
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Llembur">
                    <a href="{{ route('lead_lembur') }}" class="btn btn-info w-full"><i
                            class="ri-time-line text-xl"></i>Data
                        Lembur</a>
                </div>
        ...
        @elseif(Auth::user()->divisi->jabatan->code_jabatan == 'CO-SCR')
            <div class="mx-10 my-5 flex flex-col gap-2">
                ...
                @endif
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Labsensi">
                    <a href="{{ route('danru_absensi') }}" class="btn btn-info w-full"><i
                            class="ri-todo-line text-xl"></i>Data
                        Absensi</a>
                </div>
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Lizin">
                ...
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Llembur">
                    <a href="{{ route('danru_lembur') }}" class="btn btn-info w-full"><i
                            class="ri-time-line text-xl"></i>Data
                        Lembur</a>
                </div>
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Llaporan">
        ...
        @elseif(Auth::user()?->jabatan->code_jabatan == 'SPV-W')
            <div class="mx-10 my-5 flex flex-col gap-2">
                ...
                @endif
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Labsensi">
                    <a href="{{ route('spvw_absensi') }}" class="btn btn-info w-full"><i
                            class="ri-todo-line text-xl"></i>Data
                        Absensi</a>
                </div>
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Lizin">
                ...
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Llembur">
                    <a href="{{ route('spvw_lembur') }}" class="btn btn-info w-full"><i
                            class="ri-time-line text-xl"></i>Data
                        Lembur</a>
                </div>
                <div class=" w-full space-y-4  sm:px-16 overflow-hidden" id="Llaporan">
