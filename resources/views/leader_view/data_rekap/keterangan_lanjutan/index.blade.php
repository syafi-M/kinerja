<x-app-layout>
    <x-main-div>
        <div class="w-full max-w-3xl px-3 py-4 mx-auto sm:px-5 lg:px-6">
                    ...
                    <div class="flex items-center min-w-0 gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="mt-1 text-sm leading-5 text-slate-500">
                                Catat keterangan lanjutan untuk periode tertentu.
                            </p>
                        </div>
                    </div>
                    <a href="{{ route('keterangan-lanjutan.history') }}"
            ...
            <form action="{{ route('keterangan-lanjutan.store') }}" method="POST" class="space-y-4"
                x-data="{
