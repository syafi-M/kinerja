	...
	<script>
		...
		$(document).ready(function() {
			$('#img').change(function () {
                ...
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function (e) {
                        preview.show();
                        preview.find('img').attr('src', e.target.result).removeClass('hidden').addClass('rounded-md shadow-md my-4');
                    };
        	...
        	$('#btnDashboard').click(function () {
                $(this).prop('disabled', true).text('Tunggu...').css('background-color', 'rgba(96, 165, 250, 0.5)');
            });
		});
	</script>
</body>
