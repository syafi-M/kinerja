        ...
        <section class="grid gap-4 xl:grid-cols-2">
            <article class="bg-white border border-gray-100 shadow-sm rounded-2xl">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    ...
                    <span
                        class="px-2 py-1 text-xs font-semibold text-red-700 rounded-lg bg-red-50">{{ $expiringContracts }}</span>
                </div>
            ...
            <article class="bg-white border border-gray-100 shadow-sm rounded-2xl">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                    ...
                    <span
                        class="px-2 py-1 text-xs font-semibold rounded-lg bg-amber-50 text-amber-700">{{ $inactiveUsers }}</span>
                </div>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-500">
                                        ...
                                        @if ($user->last_attendance)
                                            {{ \Carbon\Carbon::parse($user->last_attendance)->diffForHumans() }}
                                        @else
                                            Belum pernah absen
                                        @endif
                                    </p>
