        ...
        <section class="px-0.5">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm leading-5 text-[var(--md-sys-color-on-surface-variant)]">Pilih perlengkapan yang ingin dikaitkan ke divisi <span class="font-semibold text-gray-700">{{ $data->name }}</span>.</p>
                </div>
