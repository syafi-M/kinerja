<x-app-layout>
    <x-main-div>
        <div class="py-10 px-5">
            <p class="text-center text-2xl font-bold  uppercase">Data Klien</p>
            ...
            <div class="flex justify-center overflow-x-auto mx-10 pb-10">
                <table class="table table-fixed table-zebra table-sm w-full shadow-md bg-slate-50" id="searchTable">
                    <thead>
                        <tr>
