<x-admin-layout :fullWidth="true">
        <div class="p-10">
            ...
            <form method="POST" action="{{ route('admin.holiday.store') }}" class="bg-slate-100 rounded-md py-10 px-10 my-10 gap-2"
            id="form">
				@csrf
            <div>
            ...
            {{-- button --}}
				<div class="flex justify-end my-10 gap-2">
					...
					<a href="{{ route('admin.holiday.index') }}" class="btn btn-error">
						Back
					</a>
