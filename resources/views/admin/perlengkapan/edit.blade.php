<x-app-layout>
	<x-main-div>
		<div class="py-10 px-10">
			...
			<p class="text-2xl text-center font-bold uppercase mb-10">Edit Perlengkapan</p>

			<div class="flex justify-center">
				<form action="{{ route('perlengkapan.update', $data->id) }}" method="POST">
					@csrf
					@method("PATCH")
					<div class="w-[25rem] px-2 py-2 p-2 bg-white max-w-md shadow-md rounded-md">
						<div id="inputContainer" class="flex flex-col pb-10">
							...
							<input type="text" value="{{ $data->name }}" placeholder="Input Name..." class="input input-bordered my-2" id="input"
								name="name[]" />
						</div>
