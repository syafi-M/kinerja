...
return [
    ...
    'madiun_raya' => ['madiun', 'ngawi', 'nganjuk', 'jombang', 'ponorogo', 'magetan', 'pacitan', 'surabaya', 'gresik', 'sidoarjo', 'lamongan'],
    'malang_raya' => ['malang', 'batu', 'pasuruan', 'blitar', 'lumajang'],
    'kediri_raya' => ['kediri', 'tulungagung', 'blitar', 'trenggalek', 'nganjuk', 'jombang'],
